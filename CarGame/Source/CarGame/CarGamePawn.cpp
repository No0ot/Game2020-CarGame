...
const FName ACarGamePawn::LookUpBinding("LookUp");
const FName ACarGamePawn::LookRightBinding("LookRight");
const FName ACarGamePawn::EngineAudioRPM("RPM");

#define LOCTEXT_NAMESPACE "VehiclePawn"

ACarGamePawn::ACarGamePawn()
{
	// Car mesh
...
void ACarGamePawn::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("MoveForward", this, &ACarGamePawn::MoveForward);
	PlayerInputComponent->BindAxis("MoveRight", this, &ACarGamePawn::MoveRight);
	PlayerInputComponent->BindAxis(LookUpBinding);
	PlayerInputComponent->BindAxis(LookRightBinding);

	PlayerInputComponent->BindAction("Handbrake", IE_Pressed, this, &ACarGamePawn::OnHandbrakePressed);
	PlayerInputComponent->BindAction("Handbrake", IE_Released, this, &ACarGamePawn::OnHandbrakeReleased);
	PlayerInputComponent->BindAction("SwitchCamera", IE_Pressed, this, &ACarGamePawn::OnToggleCamera);

	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &ACarGamePawn::OnResetVR); 
}

void ACarGamePawn::MoveForward(float Val)
{
	GetVehicleMovementComponent()->SetThrottleInput(Val);

}

void ACarGamePawn::MoveRight(float Val)
{
...
void ACarGamePawn::OnToggleCamera()
{
	EnableIncarView(!bInCarCameraActive);
}

void ACarGamePawn::EnableIncarView(const bool bState)
{
...
void ACarGamePawn::Tick(float Delta)
{
	Super::Tick(Delta);
...
void ACarGamePawn::UpdateHUDStrings()
{
...
void ACarGamePawn::SetupInCarHUD()
{
...
void ACarGamePawn::UpdatePhysicsMaterial()
{
